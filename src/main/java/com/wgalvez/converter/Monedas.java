...
public class Monedas extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Seleccione la divisa que desea obtener:");
        jLabel2.setName("lbltext"); // NOI18N

        jComboBox1.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Dólar", "Euro", "Libras Esterlinas", "Yen Japonés", "Won sul-coreano", "Liras Turcas", "Pesos Mexicanos", "Pesos Argentinos" }));
