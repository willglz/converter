 ...
 * @author willg
 */
public class Temperatura extends javax.swing.JDialog {

    /**
     * Creates new form Monedas
     */
    public Temperatura(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Temperatura dialog = new Temperatura(new javax.swing.JFrame(), true);
